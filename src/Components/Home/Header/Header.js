    ...
    return (
        ...
        <div className="container">
            <div className="row main">
                <div data-aos="fade-right" className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 introMar">
                ...
                <div data-aos="fade-left"  className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
