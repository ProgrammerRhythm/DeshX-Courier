...
const Map = () => {
    ...
    return (
        ...
        <div className="container">
            <div className="row">
                <div data-aos="fade-right"  data-aos-offset="300" data-aos-easing="ease-in-sine" className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    <img id="map" className="img-fluid" src={mapImg} alt="Map" />
                </div>
                <div data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine" className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 textArea align-middle" >
